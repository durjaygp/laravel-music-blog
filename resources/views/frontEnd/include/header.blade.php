                ...
                <div class="main_menu col-md-12">
                    <div class="logo_small_wrapper_table">
                        <div class="logo_small_wrapper">
                            ...
                            <a class="logo_link" href="index.html">
                                <img src="{{asset('frontEnd')}}/img/logo.png" alt="Just another WordPress site" />
                            </a>
                            <!-- end logo -->
                        </div>
                    </div>
                    ...
                    <div class="menu-primary-container navigation_wrapper">
                        <ul id="mainmenu" class="jl_main_menu">
                            ...
                            <li class="menu-item">
                                <a href="active.html">Movie<span class="border-menu"></span></a>
                            </li>
                            <li class="menu-item">
                                <a href="active.html">About<span class="border-menu"></span></a>
                            </li>
                            <li class="menu-item">
                                <a href="active.html">Contact<span class="border-menu"></span></a>
                            </li>
                        </ul>
                    </div>
                    <!-- end main menu -->
                    <div class="search_header_menu">
                        ...
                        <div class="menu_mobile_share_wrapper">
                            <ul class="social_icon_header_top">
                                ...
                                <li>
                                    <a class="google_plus" href="#" target="_blank"><i
                ...
                <div class="jellywp_about_us_widget_wrapper">
                    <div class="social_icons_widget">
                        <ul class="social-icons-list-widget icons_about_widget_display">
                            ...
                            <li>
                                <a href="#" class="google_plus" target="_blank"><i class="fa fa-google-plus"></i></a>
                            </li>
                            <li>
                                <a href="#" class="behance" target="_blank"><i class="fa fa-behance"></i></a>
                            </li>
                            <li>
                                <a href="#" class="vimeo" target="_blank"><i class="fa fa-vimeo-square"></i></a>
                            </li>
                            <li>
