                        ...
                        <div class="widget_jl_wrapper about_widget_content">
                            ...
                            <div class="jellywp_about_us_widget_wrapper">
                                <p>
                                    ...
                                    imperdiet ut imperdiet eu, iaculis a sem imperdiet ut
                                    imperdiet.
                                </p>
                                <div class="social_icons_widget">
                                    <ul class="social-icons-list-widget icons_about_widget_display">
                                        ...
                                        <li>
                                            <a href="#" class="google_plus" target="_blank"><i
                                                    class="fa fa-google-plus"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="behance" target="_blank"><i class="fa fa-behance"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="vimeo" target="_blank"><i
                                        ...
                                        <li>
                                            <a href="#" class="tumblr" target="_blank"><i class="fa fa-tumblr"></i></a>
                                        </li>
                                        <li>
                                        ...
                                        <li>
                                            <a href="#" class="deviantart" target="_blank"><i
                                                    class="fa fa-deviantart"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="dribble" target="_blank"><i class="fa fa-dribbble"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="dropbox" target="_blank"><i class="fa fa-dropbox"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="rss" target="_blank"><i class="fa fa-rss"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="skype" target="_blank"><i class="fa fa-skype"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="stumbleupon" target="_blank"><i
                                                    class="fa fa-stumbleupon"></i></a>
                                        </li>
                                        <li>
                                            <a href="#" class="wordpress" target="_blank"><i
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           title="Round white dining table on brown hardwood">
                                            <img width="120" height="120"
                                                 src="{{asset('frontEnd')}}/images/daniel-korpai-1296140-unsplash-120x120.jpg"
                                        ...
                                        <div class="item-details">
                                          <span class="meta-category-small"><a class="post-category-color-text"
                                                                               style="background: #36c942" href="#">Sports</a></span>
                                    ...
                                    <li>
                                        <a href="#"
                                           ...
                                           title="People are enjoy the job that they love">
                                            <img width="120" height="120"
                                                 src="{{asset('frontEnd')}}/images/irina-iriser-654436-unsplash-120x120.jpg"
                                                 class="attachment-disto_small_feature size-disto_small_feature wp-post-image"
                                                 alt="" />
                                            <div class="background_over_image"></div>
                                        </a>
                                        <div class="item-details">
                                          <span class="meta-category-small"><a class="post-category-color-text"
                                            ...
                                            <span class="post-meta meta-main-img auto_image_with_date">
                                             <span class="post-date"><i class="fa fa-clock-o"></i>Dec 24,
                                                2016</span></span>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div id="categories-4" class="widget widget_categories">
                        ...
                        <ul>
                            ...
                            <li class="cat-item cat-item-4">
                                <a href="#" title="Sample category description goes here">Crazy</a>
                                <span>5</span>
                            </li>
                            <li class="cat-item cat-item-5">
                                <a href="#" title="Sample category description goes here">Gaming</a>
                                <span>10</span>
                            </li>
                            <li class="cat-item cat-item-6">
                                <a href="#" title="Sample category description goes here">Health</a>
                                <span>6</span>
                            </li>
                            <li class="cat-item cat-item-7">
                                <a href="#" title="Sample category description goes here">Science</a>
                                <span>4</span>
                            </li>
                        </ul>
                    </div>
